...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner AquaGateway
	// Requirments
...
// Reconcile reads that state of the cluster for a AquaGateway object and makes changes based on the state read
// and what is in the AquaGateway.Spec
